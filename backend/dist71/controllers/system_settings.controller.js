    ...
    static async updateSettings(req, res) {
        try {
            ...
            if (notification_email !== undefined)
                $setFields['config.notification_email'] = notification_email;
            if (email_config !== undefined)
                $setFields['config.email_config'] = email_config;
            if (preferred_data_provider !== undefined)
                $setFields['config.preferred_data_provider'] = preferred_data_provider || null;
            if (preferred_airtime_provider !== undefined)
