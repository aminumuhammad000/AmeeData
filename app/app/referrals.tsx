            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.instructionSection}>
                    ...
                    <View style={styles.stepItem}>
                        <View style={[styles.stepNumber, { backgroundColor: isDark ? '#1F2937' : '#E5E7EB' }]}>
                            <Text style={{ color: theme.primary, fontWeight: '700' }}>1</Text>
                        </View>
                        <Text style={[styles.stepText, { color: textBodyColor }]}>Invite your friends using your unique referral code.</Text>
                    </View>
                    <View style={styles.stepItem}>
                        <View style={[styles.stepNumber, { backgroundColor: isDark ? '#1F2937' : '#E5E7EB' }]}>
                            <Text style={{ color: theme.primary, fontWeight: '700' }}>2</Text>
                        </View>
                        <Text style={[styles.stepText, { color: textBodyColor }]}>They register and perform their first transaction.</Text>
                    </View>
                    <View style={styles.stepItem}>
                        <View style={[styles.stepNumber, { backgroundColor: isDark ? '#1F2937' : '#E5E7EB' }]}>
                            <Text style={{ color: theme.primary, fontWeight: '700' }}>3</Text>
                        </View>
                        <Text style={[styles.stepText, { color: textBodyColor }]}>You receive ₦{settings?.referrer_bonus_amount ?? '...'} wallet bonus instantly!</Text>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    stepItem: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 12 },
